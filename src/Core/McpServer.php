...
class McpServer {
	 ...
	 *
	 * @var \WickedEvolutions\McpAdapter\Core\McpComponentRegistry
	 */
	 ...
	 *
	 * @var \WickedEvolutions\McpAdapter\Core\McpTransportFactory
	 */
	 ...
	 * @param class-string<\WickedEvolutions\McpAdapter\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface>|null         $error_handler Error handler class to use (e.g., NullMcpErrorHandler::class). Must implement McpErrorHandlerInterface. If null, NullMcpErrorHandler will be used.
	 * @param class-string<\WickedEvolutions\McpAdapter\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface>|null $observability_handler Observability handler class to use (e.g., NullMcpObservabilityHandler::class). Must implement McpObservabilityHandlerInterface. If null, NullMcpObservabilityHandler will be used.
	...
	private function setup_handlers( ?string $error_handler, ?string $observability_handler ): void {
		...
		if ( $error_handler && class_exists( $error_handler ) ) {
			/** @var \WickedEvolutions\McpAdapter\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface $handler */
		...
		if ( $observability_handler && class_exists( $observability_handler ) ) {
			/** @var \WickedEvolutions\McpAdapter\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface $handler */
	 ...
	 *
	 * @return \WickedEvolutions\McpAdapter\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface
	 */
	 ...
	 *
	 * @return \WickedEvolutions\McpAdapter\Transport\Infrastructure\McpTransportContext
	 */
	 ...
	 *
	 * @return \WickedEvolutions\McpAdapter\Core\McpComponentRegistry
	 */
