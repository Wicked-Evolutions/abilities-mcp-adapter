 ...
 *
 * @package WickedEvolutions\McpAdapter\Core
 */
...
use WickedEvolutions\McpAdapter\Servers\DefaultServerFactory;
...
final class McpAdapter {
	 ...
	 * Registry instance
	 *
	 * @var \WickedEvolutions\McpAdapter\Core\McpAdapter
	 */
	 ...
	 *
	 * @return \WickedEvolutions\McpAdapter\Core\McpAdapter
	 */
	 ...
	 * @param class-string<\WickedEvolutions\McpAdapter\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface> $error_handler The error handler class name. If null, NullMcpErrorHandler will be used.
	 * @param class-string<\WickedEvolutions\McpAdapter\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface> $observability_handler The observability handler class name. If null, NullMcpObservabilityHandler will be used.
	 ...
	 *
	 * @return \WickedEvolutions\McpAdapter\Core\McpServer|null
	 */
	 ...
	 *
	 * @return \WickedEvolutions\McpAdapter\Core\McpServer[]
	 */
