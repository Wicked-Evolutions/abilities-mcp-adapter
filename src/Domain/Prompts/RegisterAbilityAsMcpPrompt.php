...
namespace WickedEvolutions\McpAdapter\Domain\Prompts;
...
class RegisterAbilityAsMcpPrompt {
	 ...
	 *
	 * @return \WickedEvolutions\McpAdapter\Domain\Prompts\McpPrompt|\WP_Error Returns prompt instance or WP_Error if validation fails.
	 */
	 ...
	 *
	 * @return \WickedEvolutions\McpAdapter\Domain\Prompts\McpPrompt|\WP_Error MCP prompt instance or WP_Error if validation fails.
	 */
